...
<body>
	<%
		ArrayList<ProductDTO> prdlist = (ArrayList<ProductDTO>) request
				.getAttribute("prdlist");
	%>
	<%
			...
			<ul>
				...
				<li class="typeGallery"><a href="#"
					onclick="dataViewType( 2 );return false;"> <img
						src="/minishop/images/product/icn_gllry_2.gif" alt="갤러리 형" />
				</a></li>
				<li class="typeList"><a href="#"
					onclick="dataViewType( 1 );return false;"> <img
						src="/minishop/images/product/icn_list_2.gif" alt="리스트 형" />
				</a></li>
			...
			<ul class="goodsAreaG">
				...
				<li><a href="#" class="goodsLink"
					onclick="formGetSubmit( '/commerce/foffice/product/product.lime', 'r_prcode=G3227_F0001_X0001_K0004' )">
						<img
						src="/minishop/images/product/<%=pro.getImg_gen_file_nm()%>"
						alt="상품" class="photo" /><br /> <span class="proPrice1"><%=pro.getPrd_nm()%>
					...
					<ul class="bIcon">
						...
						<li><a href="#"
							onclick="basketIn( 'G3227_F0001_X0001_K0004' );return false;"><img
								src="/minishop/images/product/bcon_cart.gif" alt="장바구니" /></a></li>
						<li><a href="#" onclick="imageZoom( '44' );"><img
								src="/minishop/images/product/bcon_zoom.gif" alt="확대보기" /></a></li>
